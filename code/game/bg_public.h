...
#define PMF_WALKING			(1<<20)//1048576
...
//END JKA weapons
	...
	EV_DEBUG_LINE,
	EV_KOTHOS_BEAM,
	EV_FLAMETHROWER_ACTIVATED, // event for playing flamethrower effect
	EV_FLAMETHROWER_DEACTIVATED, // event for stopping flamethrower effect
